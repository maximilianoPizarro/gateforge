...
@Component({
            ...
            <div *ngFor="let msg of messages" [ngClass]="bubbleRowClass(msg)">
              ...
              <div [ngClass]="bubbleClass(msg)">
                <span class="bubble-label">
                  {{ msg.role === 'user' ? 'You' : 'GateForge AI' }}
                  <span *ngIf="msg.cached === true" class="badge-cached" title="Instant answer from FAQ cache">Instant</span>
                  <span *ngIf="msg.cached === false && msg.role !== 'user'" class="badge-ai" title="Generated by AI model">AI Generated</span>
                </span>
  ...
  styles: [`
    ...
    .badge-cached {
      display: inline-block; padding: 1px 6px; border-radius: 8px; font-size: 0.6rem;
      background: #3f9c35; color: white; margin-left: 6px; text-transform: none;
      letter-spacing: 0; font-weight: 600; vertical-align: middle;
    }
    .badge-ai {
      display: inline-block; padding: 1px 6px; border-radius: 8px; font-size: 0.6rem;
      background: #6a6e73; color: white; margin-left: 6px; text-transform: none;
      letter-spacing: 0; font-weight: 600; vertical-align: middle;
    }
